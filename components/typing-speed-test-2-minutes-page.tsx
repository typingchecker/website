...
export function TypingSpeedTest2MinutesPage() {
  return (
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <article className="rounded-xl border border-zinc-200 bg-white/80 p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900/40 sm:p-10">
          <h1 className="text-balance text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-3xl">
            2 Minute Typing Test – Measure Your Typing Speed and Accuracy
          </h1>

          <section className="mt-10 space-y-4">
            <h2 className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-xl">
              Test Your Typing Speed with a 2 Minute Typing Test
            </h2>
            <div className="space-y-4 text-sm leading-relaxed text-zinc-600 dark:text-neutral-400 sm:text-base">
              <p>
                A 2 minute typing test is a timed typing challenge that measures how fast and accurately you can type in
                120 seconds. During this typing speed test, the system calculates your words per minute (WPM) and
                evaluates your typing accuracy.
              </p>
              <p>
                Compared to shorter typing tests, the 2 minute typing speed test provides a more reliable measurement of
                your typing performance. Because the test lasts longer, it allows you to maintain a steady typing rhythm
                and produce more accurate WPM results.
              </p>
              <p>
                With TypingChecker, you can take a 2 minute typing test online for free and instantly see your typing
          ...
          <div className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
            <Button asChild size="lg" className="min-h-11 w-full sm:w-auto">
              <Link href="/">Start 2 minute test</Link>
            </Button>
            <p className="text-xs text-zinc-500 dark:text-neutral-500 sm:text-sm">
              ...
              and <strong className="font-medium text-zinc-700 dark:text-neutral-300">120s</strong>. The timer starts on your first
              key.
            </p>
          </div>
          ...
          <div className="mt-12 space-y-10 text-sm leading-relaxed text-zinc-600 dark:text-neutral-400 sm:text-base">
            <section>
              <h2 className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-xl">
                How the 2 Minute Typing Test Works
              </h2>
              <p className="mt-3">Taking the typing test 2 minutes challenge is simple and easy to use.</p>
              <p className="mt-3">Follow these steps:</p>
              <ol className="mt-3 list-decimal space-y-2 pl-5">
                <li>
                  Start the 2 minute typing test from the{" "}
                  <Link href="/" className="font-medium text-blue-600 underline-offset-2 hover:underline dark:text-blue-400">
                    typing test tool
                  </Link>
                  .
                </li>
                <li>Select Challenge mode and choose 120s.</li>
                <li>The timer begins automatically when you press your first key.</li>
                <li>Type the paragraph displayed on the screen as accurately as possible.</li>
                <li>The system tracks your typing speed, WPM, and typing errors in real time.</li>
                <li>When the timer ends, your typing speed results and accuracy score appear instantly.</li>
              </ol>
              <p className="mt-4">
                This timed typing test helps you evaluate your keyboard typing performance and track your progress.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-xl">
                Why Take a 2 Minute Typing Speed Test?
              </h2>
              <p className="mt-3">
                The 2 minute typing test offers several benefits for people who want to measure their typing skills more
                accurately.
              </p>
              <div className="mt-4 space-y-4">
                <div>
                  <h3 className="text-base font-semibold text-zinc-900 dark:text-white">More Reliable WPM Measurement</h3>
                  <p className="mt-1">
                    Because the test lasts longer than quick typing tests, it produces a more accurate estimate of your
                    words per minute typing speed.
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-semibold text-zinc-900 dark:text-white">
                    Better Typing Consistency Analysis
                  </h3>
                  <p className="mt-1">
                    Typing continuously for 120 seconds allows the tool to evaluate how consistently you type during a
                    longer session.
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-semibold text-zinc-900 dark:text-white">Ideal for Typing Practice</h3>
                  <p className="mt-1">
                    A 2 minute typing test is long enough to practice typing effectively while still being short enough
                ...
                <div>
                  ...
                  <p className="mt-1">
                    The typing checker highlights typing mistakes so you can improve your keyboard accuracy and
                    performance.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="mt-4">
                Most people type around 40 to 45 WPM. With regular typing practice, many users improve their typing speed
                and reach 60 WPM or more.
              </p>
              <p className="mt-3">
                Taking regular typing speed tests online helps you monitor improvements and build stronger typing skills.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">If you want to improve your WPM and typing accuracy, consider these tips:</p>
              <div className="mt-4 space-y-4">
                <div>
                  <h3 className="text-base font-semibold text-zinc-900 dark:text-white">Practice Typing Every Day</h3>
                  <p className="mt-1">
                    Regular typing practice helps develop muscle memory and improves typing speed.
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-semibold text-zinc-900 dark:text-white">Focus on Accuracy Before Speed</h3>
                  <p className="mt-1">
                ...
                <div>
                  ...
                  <p className="mt-1">
                    Using correct finger placement improves keyboard efficiency and typing performance.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1">
                    Using online typing speed tests helps you track your progress and identify areas for improvement.
                  </p>
                </div>
              </div>
              <p className="mt-4">
